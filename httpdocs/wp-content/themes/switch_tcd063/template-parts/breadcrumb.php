...
// Render
echo '<ol class="p-breadcrumb c-breadcrumb l-inner" itemscope="" itemtype="https://schema.org/BreadcrumbList">' . "\n";
...
for ( $i = 0, $len = count( $breadcrumb_items ); $i < $len; $i++ ) {
  ...
  if ( $len - 1 !== $i ) {
    ...
    if ( 0 === $i ) {
      echo '<li class="p-breadcrumb__item c-breadcrumb__item c-breadcrumb__item--home" itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">' . "\n";
    } else {
      echo '<li class="p-breadcrumb__item c-breadcrumb__item" itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">' . "\n";
    }
    echo '<a href="' . esc_url( $breadcrumb_items[$i]['url'] ) . '" itemtype="https://schema.org/Thing" itemprop="item">' . "\n";
