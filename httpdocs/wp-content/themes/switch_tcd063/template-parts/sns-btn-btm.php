...
if($thumnail_image){
	...
	$noimage = array();
	$noimage[0] = esc_url(get_bloginfo('template_url')) . "/assets/images/590x380.gif";
...
<?php
		if ( is_mobile() ) :
?>
			  	<a href="https://twitter.com/intent/tweet?text=<?php echo $title_encode ?>&url=<?php echo $url_encode ?>&via=<?php echo $dp_options['twitter_info']; ?>&tw_p=tweetbutton&related=<?php echo $dp_options['twitter_info']; ?>">
<?php
		else :
?>
...
<?php
		if ( is_mobile() ) :
?>
			    	<a href="https://b.hatena.ne.jp/add?mode=confirm&url=<?php echo $url_encode ?>">
<?php
		else :
?>
			      <a href="https://b.hatena.ne.jp/add?mode=confirm&url=<?php echo $url_encode ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=510');return false;">
<?php endif; ?>
...
?>
			    <li class="c-share__btn c-share__btn--pocket">
			    	<a href="https://getpocket.com/edit?url=<?php echo $url_encode;?>&title=<?php echo $title_encode;?>" target="_blank">
...
?>
			    <li class="c-share__btn c-share__btn--feedly">
			    	<a href="https://feedly.com/index.html#subscription/feed/<?php bloginfo('rss2_url'); ?>" target="_blank">
...
?>
			    <li class="c-share__btn c-share__btn--pinterest">
			    	<a href="https://www.pinterest.com/pin/create/button/?url=<?php echo $url_encode; ?>&media=<?php echo $pinterestimage[0]; ?>&description=<?php echo $title_encode ?>" rel="nofollow" target="_blank" data-pin-do="buttonPin" data-pin-custom="true">
