...
<footer class="l-footer">
  ...
  <?php if ( $dp_options['display_footer_links'] ) : ?>
    ...
    <section id="js-footer-link" class="p-footer-link p-footer-link--<?php echo esc_attr( $dp_options['footer_links_bg_type'] ); ?>">
      ...
      <div class="p-footer-link__inner l-inner">
        <p class="p-footer-link__title"><?php echo $dp_options['footer_links_catch']; ?></p>
        <p class="p-footer-link__desc"><?php echo nl2br($dp_options['footer_links_desc'] ); ?></p>
  ...
  <div class="p-info">
    <div class="p-info__inner l-inner">
      ...
      <p class="p-info__address"><?php echo nl2br( $dp_options['footer_address'] ); ?></p>
        ...
        <?php endif; ?>
        <?php if ( $dp_options['tiktok_url'] ) : ?>
        <li class="p-social-nav__item p-social-nav__item--tiktok"><a href="<?php echo esc_url( $dp_options['tiktok_url'] ); ?>"></a></li>
        <?php endif; ?>
  ...
  <p class="p-copyright">
  <small><?php echo nl2br( $dp_options['copyright_text'] ); ?></small>
  </p>
