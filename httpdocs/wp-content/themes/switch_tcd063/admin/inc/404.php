...
?>
<div id="tab-content-404" class="tab-content">
   ...
   <div class="theme_option_field cf theme_option_field_ac open active">
    ...
    <input type="text" class="full_width" name="dp_options[404_ph_title]" value="<?php echo esc_attr( $options['404_ph_title'] ); ?>">
    ...
    <textarea class="full_width" name="dp_options[404_ph_desc]"><?php echo esc_textarea( $options['404_ph_desc'] ); ?></textarea>
    <ul class="option_list">
     <li class="cf"><span class="label"><?php _e('Font color', 'tcd-w'); ?></span><input type="text" class="c-color-picker" name="dp_options[404_ph_desc_color]" value="<?php echo esc_attr( $options['404_ph_desc_color'] ); ?>" data-default-color="<?php echo esc_attr( $dp_default_options['404_ph_desc_color'] ); ?>"></li>
     <li class="cf"><span class="label"><?php _e('Font size', 'tcd-w'); ?></span><?php echo tcd_font_size_option($options, '404_ph_desc_font_size'); ?></li>
     <li class="cf"><span class="label"><?php _e('Font direction', 'tcd-w'); ?></span><?php echo tcd_basic_radio_button($options, '404_ph_desc_writing_mode', $ph_404_desc_writing_mode_options); ?></li>
    </ul>
    ...
    <ul class="option_list">
     <li class="cf">
  	...
  	<div class="image_box cf">
  		<div class="cf cf_media_field hide-if-no-js 404_ph_img">
  			<input type="hidden" value="<?php echo esc_attr( $options['404_ph_img'] ); ?>" id="404_ph_img" name="dp_options[404_ph_img]" class="cf_media_id">
  			<div class="preview_field"><?php if ( $options['404_ph_img'] ) { echo wp_get_attachment_image( $options['404_ph_img'], 'medium' ); } ?></div>
  			<div class="button_area">
  				<input type="button" value="<?php _e( 'Select Image', 'tcd-w' ); ?>" class="cfmf-select-img button">
  				<input type="button" value="<?php _e( 'Remove Image', 'tcd-w' ); ?>" class="cfmf-delete-img button <?php if ( ! $options['404_ph_img'] ) { echo 'hidden'; } ?>">
  			</div>
  		</div>
  	</div>
     </li>
     <li class="cf">
      ...
      <ul>
       ...
       <li><label><input type="radio" name="dp_options[404_ph_img_animation_type]" value="<?php echo esc_attr( $option['value'] ); ?>" <?php checked( $option['value'], $options['404_ph_img_animation_type'] ); ?>> <?php echo esc_html( $option['label'] ); ?></label></li>
       <?php endforeach; ?>
      </ul>
     </li>
     <li class="cf"><span class="label"><?php _e('Color of overlay', 'tcd-w'); ?></span><input class="c-color-picker" type="text" name="dp_options[404_ph_overlay]" data-default-color="<?php echo esc_attr( $dp_default_options['404_ph_overlay'] ); ?>" value="<?php echo esc_attr( $options['404_ph_overlay'] ); ?>"></li>
     <li class="cf">
      <span class="label"><?php _e('Transparency of overlay', 'tcd-w'); ?></span><input style="width:70px;" type="number" min="0" max="1.0" step="0.1" name="dp_options[404_ph_overlay_opacity]" value="<?php echo esc_attr( $options['404_ph_overlay_opacity'] ); ?>">
