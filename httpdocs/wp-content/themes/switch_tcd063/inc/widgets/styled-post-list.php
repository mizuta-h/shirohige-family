  ...
  <div class="p-tab-panel p-widget">
    ...
    for ( $i = 1; $i <= 2; $i++ ) :
      ...
      if ( $instance['display' . $i] ) :
        ...
        if ( 'recent_post' === $instance['post_type' . $i]  || 'news' === $instance['post_type' . $i] || 'event' === $instance['post_type' . $i] || 'interview' === $instance['post_type' . $i]) {
    ...
    <div class="a-widget-box__content">
      ...
      <p>
        ...
        <select id="<?php echo $this->get_field_id( 'post_type' . $i ); ?>" name="<?php echo $this->get_field_name( 'post_type' . $i ); ?>" class="widefat">
          ...
          <option value="news" <?php selected( 'news', $instance['post_type' . $i] ); ?>><?php _e( 'News', 'tcd-w' ); ?></option>
          <option value="event" <?php selected( 'event', $instance['post_type' . $i] ); ?>><?php _e( 'Event', 'tcd-w' ); ?></option>
          <option value="interview" <?php selected( 'interview', $instance['post_type' . $i] ); ?>><?php _e( 'Interview', 'tcd-w' ); ?></option>
			    <?php for ( $j = 1; $j <= 3; $j++ ) : ?>
