...
function show_seo_meta_box( $post ) {
 ...
 <div class="tcd_cf_content" style="border-bottom:none;">
  ...
  <textarea class="large-text word_count" name="<?php echo esc_attr( $seo_desc['id'] ); ?>" id="<?php echo esc_attr( $seo_desc['id'] ); ?>" cols="60" rows="2"><?php echo $seo_desc_meta ? esc_textarea( $seo_desc_meta ) : esc_textarea( $seo_desc['std'] ); ?></textarea>
...
function get_seo_description() {
	...
	// トップページの場合
 	...
 	} elseif ( (is_single() && !is_singular('interview')) || is_page() ) {
