...
?>
  <?php if ( $dp_options['load_first'] == 1 && !isset($_COOKIE['first_visit']) ) { ?>
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/tcd-cookie.js?ver=<?php echo version_num(); ?>"></script>
  <script>
