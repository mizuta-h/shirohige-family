...
<div id="tab-content-basic" class="tab-content">
   ...
   <div class="theme_option_field cf theme_option_field_ac">
	...
	<?php // OGP ?>
   <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Facebook OGP', 'tcd-w');  ?></h3>
    <div class="theme_option_field_ac_content">
	...
	<?php // Twitter Cards ?>
   <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('X Cards', 'tcd-w');  ?></h3>
    <div class="theme_option_field_ac_content">
     ...
     <p><label><input id="dp_options[use_twitter_card]" name="dp_options[use_twitter_card]" type="checkbox" value="1" <?php checked( '1', $options['use_twitter_card'] ); ?>> <?php _e( 'Use X Cards', 'tcd-w' );  ?></label></p>
